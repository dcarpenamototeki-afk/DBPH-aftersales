...
const green = ["YES", "COMPLETE", "AVAILABLE", "AVAIL", "RECEIVED", "TRUE", "ORCR + PLATE", "CLAIMED", "MATCHED", "MATCHED & MOVED", "RELEASED", "CREATE", "READY", "FOR RELEASE", "PLATE AVAILABLE", "ALREADY AVAILABLE"];
